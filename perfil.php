        ...
        <div class="d-flex justify-content-center align-items-center vh-100">
            ...
            <form class="shadow w-450 p-3" action="editar-perfil.php" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="primerNombre" value="<?php echo $_SESSION['usuario']['primerNombre'] ?>">
                </div>

                <div class="mb-3">
                    <label for="segundoNombre" class="form-label">Segundo Nombre</label>
                    <input type="text" class="form-control" name="segundoNombre" value="<?php echo $_SESSION['usuario']['segundoNombre'] ?>">
                </div>

                <div class="mb-3">
                    <label for="primerApellido" class="form-label">Primer Apellido</label>
                    <input type="text" class="form-control" name="primerApellido" value="<?php echo $_SESSION['usuario']['primerApellido'] ?>">
                </div>

                <div class="mb-3">
                    <label for="segundoApellido" class="form-label">Segundo Apellido</label>
                    <input type="text" class="form-control" name="segundoApellido" value="<?php echo $_SESSION['usuario']['segundoApellido'] ?>">
                </div>

                <div class="mb-3">
                    <label for="fechaNacimiento" class="form-label">Fecha Nacimiento</label>
                    <input type="date" class="form-control" name="fechaNacimiento" value="<?php echo $_SESSION['usuario']['fechaNacimiento'] ?>">
                </div>

                <div class="mb-3">
                    <label for="email" class="form-label">Email</label>
                    <input type="email" class="form-control" name="email" value="<?php echo $_SESSION['usuario']['email'] ?>">
                </div>
